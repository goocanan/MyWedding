...
export default function WantedPosterFrame({ label, name, parents, photo, bounty = "20.07.2026", rotationClass = "" }) {
  return (
    <div className={`wanted-poster-container ${rotationClass}`}>
      <div className="wanted-poster relative p-0 flex flex-col items-center">
        
        {/* The Pin/Nail at the top center - Simplified */}
        <div className="w-8 h-8 mb-4 rounded-full bg-[#3C2A1A] border-2 border-[#D4AF37] flex items-center justify-center">
